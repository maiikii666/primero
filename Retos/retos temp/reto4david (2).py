...
while i <= nzonas:
  linTorigen=input()
  lista1 = linTorigen.split(' ')
  lista1arr=[]  
  for k in range(7):
    lista1arr.append(int(lista1[k]))
  matrizTarreglada.append((lista1arr))
  i+=1
i=1
while i <= nzonas: 
  linPorigen=input()
  lista2 = linPorigen.split(' ')
  lista2arr=[]
  k=0  
  for k in range(7):
    lista2arr.append(float(lista2[k]))
  matrizParreglada.append((lista2arr))
  i+=1

print(matrizTarreglada)
print(matrizParreglada)
